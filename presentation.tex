...
\logo{\includegraphics[width=1.9cm]{heg-logo.jpg}}
...
\titlegraphic{
\includegraphics[scale=.2]{logo_heg_mo.jpg}\hspace{.2cm}
}
...
% page de titre
	...
	\begin{frame}{La sécurité ?}
		\begin{itemize}
			...
			\onslide<3->\item \href{http://annelaurejacquart.com/2013/11/le-site-est-mort-vive-le-site/} {{\color{blue}Le site est mort, vive le site !}} et \href{https://www.mavenhosting.com/clients/announcements.php?id=8}{{\color{blue}mavenhosting}}
...
\section{Sécurité des données}
	...
	\subsection{Chiffrement}
		...
		\begin{frame}{Méthodes}{Symétrie}
			\begin{center}
				\onslide<1-> \includegraphics[scale=.28]{symetric_cryptography_-_step_1.png}\vspace{.2cm}\\
		...
		\begin{frame}{Méthodes}{Asymétrie}
			\begin{center}
				\onslide<1-> \includegraphics[scale=.28]{Asymetric_cryptography_-_step_1.png}\vspace{.1cm}\\
